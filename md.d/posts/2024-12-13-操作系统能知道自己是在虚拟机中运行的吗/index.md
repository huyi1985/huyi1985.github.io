...
## 废案——尼奥选择了红药丸
尼奥选择了红药丸，随后墨菲斯告知尼奥现在差不多是 2199 年，而不是他以为的 1999 年。这时，墨菲斯提出了一个问题，**什么是真实**？

“什么才是真实？你怎么定义‘真实’？如果你说的‘真实’是你能触摸到的、能闻到的、能品尝到的、能看到的，那‘真实’其实就是你大脑解读的电信号。”

> What is ***real***? How do you define real? If you’re talking about what you can feel, what you can smell, what you can taste and see, then *real is simply electrical signals interpreted by your brain*. 

正如墨菲斯所说，你认为眼见为实，`systemd-detect-virt` 也是这样想的，它会优先根据从 `/sys/class/dmi/id/` 中看到的内容为判断依据，接收来着此处的信号。

但如果该文件的内容被篡改了呢？

可以看到，～也被误导了。我们改变了～的大脑接收的电信号，改变了～的认知。
```
$ VBoxManage setextradata "Ubuntu Desktop" "VBoxInternal/Devices/pcbios/0/Config/DmiSystemProduct"     "Amazon EC2"

$ VBoxManage getextradata "Ubuntu Desktop"                                                                         
Key: GUI/LastCloseAction, Value: PowerOff
Key: GUI/LastGuestSizeHint, Value: 1024,768
Key: GUI/LastNormalWindowPosition, Value: 242,143,768,603
Key: GUI/ScaleFactor, Value: 1.5
Key: VBoxInternal/Devices/pcbios/0/Config/DmiSystemProduct, Value: Amazon EC2
```
...
* https://github.com/systemd/systemd/blob/main/src/basic/virt.h
* https://github.com/systemd/systemd/blob/main/src/basic/virt.c
* https://github.com/systemd/systemd/blob/main/src/basic/virt.c

https://web.archive.org/web/20100725003848/http://www.redlightsecurity.com/2008/04/virtualization-red-pill-or-blue.html Virtualization: Red Pill or Blue?

https://docs.oracle.com/en/virtualization/virtualbox/6.0/admin/changedmi.html Configuring the BIOS DMI Information `$ VBoxManage setextradata`