...
But Guillermo Rauch, CEO of Vercel, a front-end-as-a-service product, just used the company’s [AI site builder](https://v0.dev/chat/4X85A52Dzde#vZBwKTIde4ZPopW5ExYEzIi38oM6vJzm) to come up with a new twist on CAPTCHAs, one that invites users to play the classic single-player game DOOM and kill at least three monsters. You can check it out [here](https://doom-captcha.vercel.app/).

It’s not a [wholly original](https://www.pcgamer.com/captchas-are-annoying-but-this-doom-themed-one-is-actually-fun/) idea (the DOOM as CAPTCHA part). But it’s nevertheless topping the charts over at Hacker News, whose audience of largely developers [has notes](https://news.ycombinator.com/item?id=42566112), with some complaining it’s too hard, another complimenting the project as “so metal,” and another remarking: “There are so many monsters, took me 3-4 tries…just like a real captcha!”
...
[News](https://www.pcgamer.com/uk/news/) By [Shaun Prescott](https://www.pcgamer.com/uk/author/shaun-prescott/) published 25 May 2021

Shoot imps to prove you’re human.

![Doom CAPTCHA](img5.webp)
...
It’s called DOOM CAPTCHA, and it involves shooting three Doom imps within a short (almost _too_ short) period of time. Weirdly, the imp exists in the Wolfenstein universe, but that inconsistency doesn’t matter because no matter where they are, shooting imps is fun.

Camps Orteza writes on the [CAPTCHA’s Github page](https://vivirenremoto.github.io/doomcaptcha/) that they "had the idea this Friday, developed the first version on Saturday morning, published that night and went live here on Sunday.” It’s also noted that it’d be pretty easy to “break the security” of the CAPTCHA, and that the project is mainly for fun. In keeping with the theme, if you type IDDQD while the CAPTCHA is live, you can skip it entirely.

It does make you think, though, of an alternative world where CAPTCHAs are not gruelling, confusing, sometimes mind-boggling pests. If you want to try it out, head over to [Camps Orteza’s Github page](https://vivirenremoto.github.io/doomcaptcha/).

Cheers, [PC Mag](https://au.pcmag.com/games/87378/tired-of-boring-captchas-this-developer-created-a-doom-themed-one).
