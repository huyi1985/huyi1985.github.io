...
![Decoy Font 渲染的文本示例](/assets/b59cgo.png)
...
![经典的空间频率叠加错觉图：近看是爱因斯坦，远看或眯眼后变为玛丽莲·梦露](/assets/qqr0se.webp)
...
![Decoy Font 成功误导了元宝](/assets/wuo6jz.webp)
...
从 CAPTCHA 到今天的 Decoy Font，人类一直在尝试利用自身视觉系统与 AI 视觉模型之间的差异，构建新的信息表达方式。随着视觉大模型不断发展，这场围绕“谁能读懂文字”的较量，或许才刚刚开始。
