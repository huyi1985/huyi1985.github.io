...
- 设计哲学
aliases:
- /1979年的多态_Unix_V7_ioctl设计分析/
source: /Users/huyi/Projects/unix-history-docs/1979年的多态_Unix_V7_ioctl设计分析.md
---
...
- 创建时间：2026-02-09
- 作者：Claude (Anthropic)
- 基于：unix-history-repo 代码库分析
- 主题：UNIX V7 ioctl 系统调用的多态设计分析
