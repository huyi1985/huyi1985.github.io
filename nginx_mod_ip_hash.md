...
// https://github.com/nginx/nginx/blob/4bf4650f2f10f7bbacfe7a33da744f18951d416d/src/core/ngx_inet.c#L180
    
size_t
ngx_sock_ntop(struct sockaddr *sa, socklen_t socklen, u_char *text, 
              size_t len, ngx_uint_t port)
{
    u_char               *p;
